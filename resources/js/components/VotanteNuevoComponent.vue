      ...
      <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label>Telefono <code>*</code></label>
              ...
              <div class="form-group">
                <label>Direccion <code>*</code></label>
...
export default {
  mounted() {
    ...
    return {
      baseUrl : '',
      loaderGuardar :false,
      objVotante:{'documento':'','nombre':'','telefono':'','direccion':'','barrio':'','lider':false,'idlider':''},
      errores:[],
      listaLideres:[],
      listaBarrios:[]
    }
    ...
    guardar:function(){
      ...
      axios.post(url,this.objVotante).then(response =>{
        ...
        this.errores=[];
        this.objVotante={'documento':'','nombre':'','telefono':'','direccion':'','barrio':'','lider':false,'idlider':''};
        this.getLideres();
        swal({
